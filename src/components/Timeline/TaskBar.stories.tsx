...
export const LongTitleOverflow: Story = {
  args: {
    ...defaultArgs,
    title:
      "Phase 1: Database Setup - Migration Scripts, Schema Design, and Index Optimization",
    width: 100,
  },
};
...
export const SlateBar: Story = {
  args: {
    ...
    progressColor: "slate" as GanttColor,
  },
};
...
export const EmeraldBar: Story = {
  args: {
    ...defaultArgs,
    barColor: "emerald" as GanttColor,
...
export const AmberBar: Story = {
  args: {
    ...defaultArgs,
    barColor: "amber" as GanttColor,
    progressColor: "amber" as GanttColor,
  },
};
...
export const RoseBar: Story = {
  args: {
    ...defaultArgs,
    barColor: "rose" as GanttColor,
    progressColor: "rose" as GanttColor,
  },
};
...
export const VioletBar: Story = {
  args: {
    ...defaultArgs,
    barColor: "violet" as GanttColor,
    progressColor: "violet" as GanttColor,
  },
};
...
export const CyanBar: Story = {
  args: {
    ...defaultArgs,
    barColor: "cyan" as GanttColor,
    progressColor: "cyan" as GanttColor,
  },
};
...
export const RadiusNone: Story = {
  args: {
    ...defaultArgs,
    radius: "none" as GanttCustomization["taskBarRadius"],
  },
};
...
export const RadiusFull: Story = {
  args: {
    ...defaultArgs,
    radius: "full" as GanttCustomization["taskBarRadius"],
  },
};
